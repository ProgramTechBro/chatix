...
class InlinePostVideo extends StatefulWidget {
  const InlinePostVideo({super.key, required this.videoUrl, required this.thumbnailAsset});
...
class _InlinePostVideoState extends State<InlinePostVideo> {
  late final VideoPlayerController _controller = VideoPlayerController.networkUrl(Uri.parse(widget.videoUrl));
